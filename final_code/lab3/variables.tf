  ...
  default = {
    oregon = {
      ...
      vpc3 = {
        ...
        cwan_subnet_cidrs      = ["10.0.2.96/28", "10.0.2.112/28"]
        instance_type          = "t2.micro"
      }
    }
    stockholm = {
    ...
    sydney = {
      vpc1 = {
        ...
        workload_subnet_cidrs  = ["10.2.0.0/28", "10.2.0.16/28"]
        endpoints_subnet_cidrs = ["10.2.0.32/28", "10.2.0.48/28"]
      ...
      vpc2 = {
        ...
        workload_subnet_cidrs  = ["10.2.1.0/28", "10.2.1.16/28"]
        endpoints_subnet_cidrs = ["10.2.1.32/28", "10.2.1.48/28"]
      ...
      vpc3 = {
        ...
        workload_subnet_cidrs  = ["10.2.2.0/28", "10.2.2.16/28"]
        endpoints_subnet_cidrs = ["10.2.2.32/28", "10.2.2.48/28"]
        cwan_subnet_cidrs      = ["10.2.2.64/28", "10.2.2.80/28"]
        instance_type          = "t2.micro"
      }
      vpc4 = {
        routing_domain         = "nonprod"
        ...
        workload_subnet_cidrs  = ["10.2.3.0/28", "10.2.3.16/28"]
        endpoints_subnet_cidrs = ["10.2.3.32/28", "10.2.3.48/28"]
        cwan_subnet_cidrs      = ["10.2.3.64/28", "10.2.3.80/28"]
        instance_type          = "t2.micro"
      }
    }
  }
