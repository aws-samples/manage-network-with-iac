...
output "oregon" {
  ...
  value = {
    ...
    transit_gateway_route_tables = {
      ...
      peering      = aws_ec2_transit_gateway_route_table.oregon_tgw_peering_rt.id
    }
...
output "stockholm" {
  ...
  value = {
    ...
    transit_gateway_route_tables = {
      ...
      peering      = aws_ec2_transit_gateway_route_table.stockholm_tgw_peering_rt.id
    }
...
output "transit_gateway_peering" {
  description = "Transit Gateway peering ID."
